...
namespace PCConfiguration.Core.Services
{
    public class CPUCoolerService : IService<IRepository<CPUCooler>, CPUCooler>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CPUCoolerService"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Creates the <see cref="CPUCooler"/>.
        /// </summary>
        /// <param name="cpuCooler">The cpu cooler.</param>
        ...
        /// <summary>
        /// Gets all cpu coolers asynchronously.
        /// </summary>
        /// <returns>Collection of  <see cref="CPUCooler"/>.</returns>
        ...
        /// <summary>
        /// Calculates the price of the <see cref="CPUCooler"/> by the given quantity.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <param name="quantity">The quantity.</param>
        /// <returns>The price of the <see cref="CPUCooler"/>.</returns>
        ...
        /// <summary>
        /// Gets the <see cref="CPUCooler"/> by identifier asynchronously.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>An instance of the <see cref="CPUCooler"/></returns>
