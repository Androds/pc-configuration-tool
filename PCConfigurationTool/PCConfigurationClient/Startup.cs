...
namespace PCConfigurationClient
{
    public class Startup
    {
        ...
        public void ConfigureServices(IGenericServiceCollection services)
        {
        ...
        private static void RegisterServices(IGenericServiceCollection services)
        {
        ...
        private static void RegisterRepositories(IGenericServiceCollection services)
        {
